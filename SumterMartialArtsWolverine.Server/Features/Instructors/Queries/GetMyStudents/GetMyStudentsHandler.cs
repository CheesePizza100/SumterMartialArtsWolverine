...
public class GetMyStudentsHandler
{
    ...
    public GetMyStudentsHandler(AppDbContext dbContext, ICurrentUserService currentUserService)
    {
        _dbContext = dbContext;
        _currentUserService = currentUserService;
    }

    public async Task<List<InstructorStudentDto>> Handle(GetMyStudentsQuery request, CancellationToken cancellationToken)
    {
